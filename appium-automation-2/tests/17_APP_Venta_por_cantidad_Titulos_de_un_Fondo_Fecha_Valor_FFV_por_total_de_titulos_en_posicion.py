...
class TestValmexApp:
    ...
    def test_17_APP_Venta_por_cantidad_Titulos_de_un_FFV_por_total_de_titulos_en_posicion(self, valmex_driver):
        """
        ...
        excel_path = os.path.join(
            project_root,
            "test_data",
            "17_APP_Venta_por_cantidad_Titulos_de_un_Fondo_Fecha_Valor_FFV_por_total_de_titulos_en_posicion.xlsx",
        )
