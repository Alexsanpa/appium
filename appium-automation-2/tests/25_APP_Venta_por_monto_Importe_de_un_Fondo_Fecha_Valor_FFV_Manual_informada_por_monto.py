...
class TestValmexApp:
    ...
    def test_25_APP_Venta_por_monto_Importe_de_un_FFV_Manual_informada_por_monto(self, valmex_driver):
        """
        ...
        excel_path = os.path.join(
            project_root,
            "test_data",
            "25_APP_Venta_por_monto_Importe_de_un_Fondo_Fecha_Valor_FFV_Manual_informada_por_monto.xlsx",
        )
