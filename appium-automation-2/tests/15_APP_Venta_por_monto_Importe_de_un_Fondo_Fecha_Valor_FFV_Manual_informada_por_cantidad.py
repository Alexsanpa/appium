...
class TestValmexApp:
    ...
    def test_15_APP_Venta_por_monto_Importe_de_un_FFV_Manual_informada_por_cantidad(self, valmex_driver):
        """
        ...
        excel_path = os.path.join(
            project_root,
            "test_data",
            "15_APP_Venta_por_monto_Importe_de_un_Fondo_Fecha_Valor_FFV_Manual_informada_por_cantidad.xlsx",
        )
    ...
    def step_02_ingresar_password(self, driver):
        ...
        take_evidence(driver)
        sleep(24)  # Espera para asegurar que la pantalla de inicio se haya cargado
    ...
    def step_05_seleccionar_fondo(self, driver):
        ...
        assert (
            self.vender_page.select_fund_by_name(
                self.data["fondo"]  # Que liquide hoy
            )
            is True
