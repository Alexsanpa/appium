...
class TestValmexApp:
    ...
    def test_24_APP_Venta_por_monto_Importe_de_un_FFV_posicion_encorto_al_ejecutar(self, valmex_driver):
        """
        ...
        excel_path = os.path.join(
            project_root,
            "test_data",
            "24_APP_Venta_por_monto_Importe_de_un_Fondo_Fecha_Valor_FFV_posicion_encorto_al_ejecutar.xlsx",
        )
